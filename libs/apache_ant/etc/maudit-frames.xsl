    ...
    <xsl:template match="classes" mode="all.packages">
        <html>
            ...
            <body>
                ...
                <h2>Packages</h2>
                <table width="100%">
                    <xsl:apply-templates select="class[not(./@package = preceding-sibling::class/@package)]"
                                         mode="all.packages">
                ...
                <table border="0" width="100%">
                    <tr>
                        <td style="text-align: justify;">
                            ...
                            generally
                            reported with a reference to the <a href="https://docs.oracle.com/javase/specs/">Java
                            ...
                            Rules checked also enforce adherence to <a
                                href="https://www.oracle.com/technetwork/java/codeconvtoc-136057.html">Sun Java coding
                            guidelines
                        </a> in use at Jakarta.
                            <p/>
                ...
                <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
                    ...
                    <xsl:for-each select="class[not(./@package = preceding-sibling::class/@package)]">
                        ...
                        <tr>
                            ...
                            <td>
                                <xsl:value-of
                                        select="sum(/classes/class[./@package = current()/@package]/@violations)"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td style="text-align:right">
                    <h2>Source Code Audit</h2>
                </td>
            </tr>
            <tr>
                <td style="text-align:right">Designed for use with Webgain QA/Metamata Audit and <a
