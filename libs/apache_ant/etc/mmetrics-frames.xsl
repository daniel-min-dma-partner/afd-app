...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
  ...
  <xsl:template match="class" mode="class.name">
    <xsl:if test="parent::class"><xsl:apply-templates select="parent::class" mode="class.name"/>.
  ...
  <xsl:template match="class" mode="class.details">
    ...
    <HTML>
      ...
      <BODY>
        ...
        <H3>Class
          <xsl:if test="not($package.name = 'unnamed package')"><xsl:value-of select="$package.name"/>.
          </xsl:if>
          <xsl:value-of select="@name"/>
        </H3>
      ...
      <BODY>
        ...
        <TABLE WIDTH="100%">
          ...
          <xsl:for-each select="$doctree/classes/class[@package = current()/@name]">
            ...
            <tr>
              <td nowrap="nowrap">
                <a href="{@name}.html" target="classFrame">
                  <xsl:value-of select="@name"/>
                </a>
              </td>
            </tr>
    ...
    <html>
      ...
      <body onload="open('allclasses-frame.html','classListFrame')">
        ...
        <table class="log" border="0" cellpadding="5" cellspacing="2" width="100%">
          <tr>
            <th>
              <a href="metrics-reference.html#V(G)">V(G)</a>
            </th>
            <th>
              <a href="metrics-reference.html#LOC">LOC</a>
            </th>
            <th>
              <a href="metrics-reference.html#DIT">DIT</a>
            </th>
            <th>
              <a href="metrics-reference.html#NOA">NOA</a>
            </th>
            <th>
              <a href="metrics-reference.html#NRM">NRM</a>
            </th>
            <th>
              <a href="metrics-reference.html#NLM">NLM</a>
            </th>
            <th>
              <a href="metrics-reference.html#WMC">WMC</a>
            </th>
            <th>
              <a href="metrics-reference.html#RFC">RFC</a>
            </th>
            <th>
              <a href="metrics-reference.html#DAC">DAC</a>
            </th>
            <th>
              <a href="metrics-reference.html#FANOUT">FANOUT</a>
            </th>
            <th>
              <a href="metrics-reference.html#CBO">CBO</a>
            </th>
            <th>
              <a href="metrics-reference.html#LCOM">LCOM</a>
            </th>
            <th>
              <a href="metrics-reference.html#NOCL">NOCL</a>
            </th>
          </tr>
          <xsl:apply-templates select="." mode="print.metrics"/>
        </table>
      ...
      <tr>
        <td class="bannercell" rowspan="2">
          <a href="https://ant.apache.org/">
            <img src="https://ant.apache.org/images/group-logo.gif" alt="https://ant.apache.org" align="left"
                 border="0"/>
          </a>
        </td>
        <td style="text-align:right">
          <h2>Source Code Metrics</h2>
        </td>
      </tr>
      <tr>
        <td style="text-align:right">Designed for use with Webgain QA/Metamata Metrics and <a
                href='https://ant.apache.org'>Ant</a>.
        </td>
      </tr>
    </table>
    <hr size="1"/>
  ...
  <xsl:template match="method" mode="print.metrics">
    <tr>
      ...
      <td>
        <xsl:apply-templates select="@vg"/>
      </td>
      <td>
        <xsl:apply-templates select="@loc"/>
      </td>
      <td>
        <xsl:apply-templates select="@fanout"/>
      </td>
      <td>
        <xsl:apply-templates select="@cbo"/>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="class" mode="print.metrics">
    <tr>
      ...
      <td>
        <xsl:apply-templates select="@dit"/>
      </td>
      <td>
        <xsl:apply-templates select="@noa"/>
      </td>
      <td>
        <xsl:apply-templates select="@nrm"/>
      </td>
      <td>
        <xsl:apply-templates select="@nlm"/>
      </td>
      <td>
        <xsl:apply-templates select="@wmc"/>
      </td>
      <td>
        <xsl:apply-templates select="@rfc"/>
      </td>
      <td>
        <xsl:apply-templates select="@dac"/>
      </td>
      <td>
        <xsl:apply-templates select="@fanout"/>
      </td>
      ...
      <td>
        <xsl:apply-templates select="@lcom"/>
      </td>
      <td>
        <xsl:apply-templates select="@nocl"/>
      </td>
    </tr>
  </xsl:template>
  ...
  <xsl:template match="metrics" mode="print.metrics">
    <tr>
      ...
      <td>
        <xsl:apply-templates select="./package/@vg"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@loc"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@dit"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@noa"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@nrm"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@nlm"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@wmc"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@rfc"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@dac"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@fanout"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@cbo"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@lcom"/>
      </td>
      <td>
        <xsl:apply-templates select="./package/@nocl"/>
      </td>
    </tr>
  </xsl:template>
