...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
            ...
            <body onload="open('allclasses-frame.html','classListFrame')">
                ...
                <table class="log" cellpadding="5" cellspacing="2" width="100%">
                    ...
                    <tr class="a">
                        ...
                        <td>
                            <xsl:value-of select="count(package/class)"/>
                        </td>
                        <td>
                            <xsl:value-of
                                    select="format-number(cov.data/@hit_methods div cov.data/@total_methods,'0.0%')"/>
                        </td>
                        <td>
                ...
                <table class="log" cellpadding="5" cellspacing="2" width="100%">
                    ...
                    <xsl:for-each select="package">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{translate(@name,'.','/')}/package-summary.html">
                                    <xsl:value-of select="@name"/>
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                <xsl:value-of
                                        select="format-number(cov.data/@hit_lines div cov.data/@total_lines,'0.0%')"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                </table>
    ...
    <xsl:template name="pageHeader">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="bannercell" rowspan="2">
                    <a href="https://ant.apache.org/">
                        <img src="https://ant.apache.org/images/group-logo.gif" alt="https://ant.apache.org"
                             align="left" border="0"/>
                    </a>
                </td>
            ...
            <tr>
                <td style="text-align:right">Designed for use with Sitraka JProbe and <a href='https://ant.apache.org'>
                    Ant</a>.
                </td>
            </tr>
        </table>
    ...
    <xsl:template match="package|class" mode="stats">
        <tr>
            ...
            <td>
                <xsl:value-of select="format-number(cov.data/@hit_methods div cov.data/@total_methods,'0.0%')"/>
            </td>
            <td>
                <xsl:value-of select="format-number(cov.data/@hit_lines div cov.data/@total_lines,'0.0%')"/>
            </td>
