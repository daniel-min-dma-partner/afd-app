...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
            ...
            <body>
                ...
                <table width="100%" class="details">
                    <tr>
                        ...
                        <th>Total Classes</th>
                        <th>
                            <a href="overview-explanations.html#EXnumber">Abstract Classes</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXnumber">Concrete Classes</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXafferent">Afferent Couplings</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXefferent">Efferent Couplings</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXabstractness">Abstractness</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXinstability">Instability</a>
                        </th>
                        <th>
                            <a href="overview-explanations.html#EXdistance">Distance</a>
                        </th>
                    ...
                    <xsl:for-each select="./Packages/Package">
                        <xsl:if test="count(error) = 0">
                            <tr>
                                <td align="left">
                                    <a>
                                        <xsl:attribute name="href">overview-packages.html#PK
            ...
            <body>
                ...
                <xsl:for-each select="./Packages/Package">
                    <xsl:if test="count(error) = 0">
                        ...
                        <table width="100%">
                            <tr>
                                <td><a href="overview-explanations.html#EXafferent">Afferent Couplings</a>:
                                    <xsl:value-of select="Stats/Ca"/>
                                </td>
                                <td><a href="overview-explanations.html#EXefferent">Efferent Couplings</a>:
                                    <xsl:value-of select="Stats/Ce"/>
                                </td>
                                <td><a href="overview-explanations.html#EXabstractness">Abstractness</a>:
                                    <xsl:value-of select="Stats/A"/>
                                </td>
                                <td><a href="overview-explanations.html#EXinstability">Instability</a>:
                                    <xsl:value-of select="Stats/I"/>
                                </td>
                                <td><a href="overview-explanations.html#EXdistance">Distance</a>:
                                    <xsl:value-of select="Stats/D"/>
                                </td>
                            </tr>
                        </table>
        ...
        <html>
            ...
            <body>
                ...
                <p>The following explanations are for quick reference and are lifted directly from the original <a
                        href="https://github.com/clarkware/jdepend">JDepend documentation</a>.
                </p>
                ...
                <p>The ratio of efferent coupling (Ce) to total coupling (Ce / (Ce + Ca)). This metric is an indicator
                ...
                <p>A package squarely on the main sequence is optimally balanced with respect to its abstractness and
                    stability. Ideal packages are either completely abstract and stable (x=0, y=1) or completely
                    concrete and instable (x=1, y=0).
                </p>
                <p>The range for this metric is 0 to 1, with D=0 indicating a package that is coincident with the main
    ...
    <xsl:template match="JDepend/Cycles/Package" mode="all.cycles">
        <tr>
            <td nowrap="nowrap">
                <a href="overview-cycles.html#CY{@Name}" target="classFrame">
                    <xsl:value-of select="@Name"/>
                </a>
            </td>
        </tr>
    ...
    <xsl:template name="pageHeader">
        ...
        <table width="100%">
            <tr>
                <td align="left"></td>
                <td align="right">Designed for use with <a href="https://github.com/clarkware/jdepend">JDepend
                </a> and <a href="https://ant.apache.org">Ant</a>.
                </td>
            </tr>
        </table>
        <hr size="1"/>
