...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
        ...
        <html>
            ...
            <frameset cols="20%,80%">
                ...
                <noframes>
                    <h2>Frame Alert</h2>
                    <p>
                        This document is designed to be viewed using the frames feature. If you see this message, you
                        are using a non-frame-capable web client.
                    </p>
                </noframes>
            </frameset>
        </html>
    ...
    <xsl:template match="testsuite" mode="class.details">
        ...
        <xsl:variable name="class.name">
            <xsl:if test="not($package.name = '')"><xsl:value-of select="$package.name"/>.
            </xsl:if>
            <xsl:value-of select="@name"/>
        </xsl:variable>
        <html>
          ...
          win.focus();
            ...
            <body>
                ...
                <div class="Properties">
                    <a>
                        <xsl:attribute name="href">javascript:displayProperties('<xsl:value-of select="@package"/>.
                            <xsl:value-of select="@name"/>');
                        </xsl:attribute>
                        Properties &#187;
                    </a>
                ...
                <xsl:if test="string-length(./system-out)!=0">
                    <div class="Properties">
                        <a>
                            <xsl:attribute name="href">./<xsl:value-of select="@id"/>_<xsl:value-of select="@name"/>
                                -out.html
                            </xsl:attribute>
                            System.out &#187;
                        </a>
            ...
            <body>
                ...
                <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <a title="Display all skipped test" href="alltests-skipped.html">
                ...
                <table border="0" width="95%">
                    <tr>
                        <td style="text-align: justify;">
                            Note: <em>failures</em> are anticipated and checked for with assertions while <em>errors
                        </em> are unanticipated.
                        </td>
                    </tr>
                </table>
                ...
                <table class="details" border="0" cellpadding="5" cellspacing="2" width="95%">
                    ...
                    <xsl:for-each select="testsuite[not(./@package = preceding-sibling::testsuite/@package)]">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <xsl:value-of select="sum($insamepackage/@skipped)"/>
                            </td>
                            <td>
                                <xsl:call-template name="display-time">
                            ...
                            <td>
                                <xsl:value-of select="$insamepackage/@hostname"/>
                            </td>
                        </tr>
                    </xsl:for-each>
                </table>
    ...
    <xsl:template name="pageHeader">
        ...
        <table width="100%">
            <tr>
                <td align="left"></td>
                <td align="right">Designed for use with <a href="https://www.junit.org/">JUnit</a> and <a
            ...
            <td>
                <xsl:choose>
                    <xsl:when test="@skipped != 0">
                        <a title="Display only skipped tests" href="{@id}_{@name}-skipped.html">
    ...
    <xsl:template name="JS-escape">
        ...
        <xsl:param name="tmp2"
                   select="string:replaceAll(string:new(string($tmp1)),&quot;'&quot;,&quot;\\&apos;&quot;)"/>
