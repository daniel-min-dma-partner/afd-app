...
urlpatterns = [
    ...
    re_path(r'^sfdc/env/connect/(?P<env_name>\w+)/(?P<action>\w+)/$', main.SfdcConnect.as_view(), name="sfdc-connect"),
    ...
    path('connections/status/', main.ConnectionStatus.as_view(), name='connection-status'),
