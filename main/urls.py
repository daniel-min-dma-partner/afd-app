...
urlpatterns = [
    ...
    re_path(r'^dataflow-manager/', include([
        ...
        re_path(r'^deprecate-fields/', include([
            ...
            re_path(r'^view/details/(?P<pk>\d+)$', main.DeprecationDetailsView.as_view(), name='view-deprecation-detail'),
            re_path(r'^compare-side-by-side/(?P<pk>\d+)$', main.compare_deprecation, name='compare-side-by-side'),
            re_path(r'^compare-side-by-side/(?P<pk>\d+)/(?P<upload>\w+)$', main.compare_deprecation, name='compare-side-by-side'),
            re_path(r'^compare/(?P<pk>\d+)/$', main.CompareDeprecationView.as_view(), name='compare-deprecation'),
            re_path(r'^compare/(?P<pk>\d+)/(?P<upload>\w+)$', main.CompareDeprecationView.as_view(), name='compare-deprecation'),
